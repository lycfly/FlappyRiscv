...
import protus.backbone.{DecoderService, DynBundleAccess, FormalService, InstructionType, IntAluService, IssueService, LsuAccessWidth, LsuAddressTranslator, LsuOperationType, LsuService, MemBusControl, MemoryService, Opcodes, Pipeline, PipelineData, Plugin, Stage, TrapCause, TrapService, Utils}
