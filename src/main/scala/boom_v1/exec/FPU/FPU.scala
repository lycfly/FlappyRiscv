...
object FPConstants
{
  def FCMD_ADD =    BitMap("b0??00")
  def FCMD_SUB =    BitMap("b0??01")
  def FCMD_MUL =    BitMap("b0??10")
  def FCMD_MADD =   BitMap("b1??00")
  def FCMD_MSUB =   BitMap("b1??01")
  def FCMD_NMSUB =  BitMap("b1??10")
  def FCMD_NMADD =  BitMap("b1??11")
  def FCMD_DIV =    BitMap("b?0011")
  def FCMD_SQRT =   BitMap("b?1011")
  def FCMD_SGNJ =   BitMap("b??1?0")
  def FCMD_MINMAX = BitMap("b?01?1")
  def FCMD_CVT_FF = BitMap("b??0??")
  def FCMD_CVT_IF = BitMap("b?10??")
  def FCMD_CMP =    BitMap("b?01??")
  def FCMD_MV_XF =  BitMap("b?11??")
  def FCMD_CVT_FI = BitMap("b??0??")
  def FCMD_MV_FX =  BitMap("b??1??")
  def FCMD_X =      BitMap("b?????")
  val FCMD_WIDTH = 5
...
trait HasFPUCtrlSigs {
  val cmd = Bits(width = FPConstants.FCMD_WIDTH bits)
  val ldst = Bool()
  val wen = Bool()
  val ren1 = Bool()
  val ren2 = Bool()
